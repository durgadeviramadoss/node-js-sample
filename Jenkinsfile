node {
   echo 'Hello Docker'
    ...
    stage 'Docker image tag'
        sh 'echo $(aws ecr get-login --region us-east-1 --registry-ids 958306274) > file.txt'
    ...
    stage 'Docker image push'
        sh 'sudo docker push 958306274.dkr.ecr.us-east-1.amazonaws.com/demo-jenkins-pipeline:nodejs-image-new-v1'
